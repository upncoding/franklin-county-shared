...
import { createContext as eI, useEffect as O, useContext as AI, forwardRef as oI, useState as F, useRef as U } from "react";
import { Link as rI, useLocation as V, NavLink as D } from "react-router-dom";
import { useFloating as nI, autoUpdate as tI, offset as lI, flip as aI, shift as iI, FloatingPortal as sI } from "@floating-ui/react";
import { AnimatePresence as B, motion as Z } from "framer-motion";
const cI = {
...
function pI({ children: o, theme: A }) {
  const C = A ?? dI();
  return O(() => {
...
const Y = ({
  ...
  const [t, i] = F(!1), [b, u] = F(null), a = U(null), E = U(null), m = U(null), d = U(null), v = U(null), S = U(!1), { theme: j } = k(), Q = V(), N = `nav-menu-${o.replace(/\s+/g, "-").toLowerCase()}`, p = C.some((l) => Q.pathname === l.url ? !0 : l.subItems ? l.subItems.some((w) => Q.pathname === w.url) : !1), s = Q.pathname === A || p, x = () => {
    if (E.current) {
  ...
  }, M = t || s ? j.colors.secondary.DEFAULT : g || "rgba(255, 255, 255, 0.9)", T = "mx-4 my-2 text-xs font-bold uppercase tracking-widest transition-colors inline-block relative z-20 bg-transparent border-0 cursor-pointer p-0";
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ I("div", { className: "container mx-auto px-6", onMouseLeave: y, children: /* @__PURE__ */ I(
            "div",
            {
              ...
              children: /* @__PURE__ */ I("div", { className: `grid ${G()} gap-4 p-8`, children: C.map((l, w) => /* @__PURE__ */ r("div", { className: "flex flex-col", children: [
                /* @__PURE__ */ I(
                  L,
                  {
                    item: l,
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ r(
            "div",
            {
              ...
              onMouseLeave: y,
              children: [
                /* @__PURE__ */ I("div", { className: `grid ${G()} gap-2 p-4`, children: C.map((l, w) => /* @__PURE__ */ r("div", { className: "flex flex-col", children: [
                  /* @__PURE__ */ I(
                    L,
                    {
                      item: l,
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      style: {
        ...
        backgroundColor: o.colors.bg.header
      },
      children: [
        /* @__PURE__ */ I(
          Y,
  ...
  return /* @__PURE__ */ I("form", { onSubmit: (g) => {
    ...
    /* @__PURE__ */ I(
      "input",
      {
        ...
        placeholder: "Search...",
        "aria-label": "Search",
        className: `${A ? "w-full" : "w-48"} px-4 py-2 pr-10 text-sm rounded-xl border transition-all duration-200 focus:outline-none focus:ring-2`,
        style: {
    ...
    /* @__PURE__ */ I(
      "button",
      {
        ...
        style: { color: C.colors.text.onDark },
    ...
    m.length > 0 && /* @__PURE__ */ r(
      "nav",
      {
        ...
        children: [
          ...
          e && /* @__PURE__ */ I(mI, { onSearch: g })
        ]
      }
    ),
    (A.length > 0 || C) && /* @__PURE__ */ I(
      "button",
      {
        type: "button",
...
}, W = "518-891-2280", EI = "36 Church St Saranac Lake NY 12983", xI = /* @__PURE__ */ r(z, { children: [
  "36 Church St",
  /* @__PURE__ */ I("br", {}),
  ...
  const { theme: C } = k(), e = o === W ? EI : void 0;
  return /* @__PURE__ */ I(
    "footer",
    {
      ...
      style: {
        backgroundColor: C.colors.bg.footer,
          ...
          /* @__PURE__ */ r("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ I("div", { className: "bg-white/10 p-4 rounded-full", "aria-hidden": "true", children: /* @__PURE__ */ I(
              "svg",
              {
                ...
                viewBox: "0 0 24 24",
                "aria-hidden": "true",
                style: { color: C.colors.secondary.DEFAULT },
                children: /* @__PURE__ */ I(
                  "path",
                  {
                    strokeLinecap: "round",
            ...
            /* @__PURE__ */ r("div", { children: [
              ...
              /* @__PURE__ */ I(
                "a",
                {
                  href: `tel:${o.replace(/\D/g, "")}`,
                  className: "text-lg font-semibold transition-colors",
                  style: { color: C.colors.text.onDark },
                  onMouseEnter: (g) => g.currentTarget.style.color = C.colors.secondary.DEFAULT,
                  onMouseLeave: (g) => g.currentTarget.style.color = C.colors.text.onDark,
                  "aria-label": `Call ${o}`,
                  children: o
                }
              )
  ...
  for (const C of o)
    if (C.items && C.items.length > 0) {
      for (const e of C.items)
        if (A.push({ label: e.label, url: e.url, groupLabel: C.label }), e.subItems)
          for (const g of e.subItems)
            A.push({ label: g.label, url: g.url, groupLabel: C.label });
    } else C.url && A.push({ label: C.label, url: C.url });
  return A;
}
function wI({
  children: o,
  ...
  const [a, E] = F(!1), [m, d] = F(!1), [v, S] = F(!1), [j, Q] = F(80), N = V(), { theme: p } = k(), s = U(null), x = U(null), f = U(null), J = U(null);
  O(() => {
  ...
  return /* @__PURE__ */ r("div", { ref: J, className: "min-h-screen flex flex-col font-sans text-county-charcoal", children: [
        ...
        children: /* @__PURE__ */ I("div", { className: "overflow-y-auto flex-1 pt-32 pb-8", tabIndex: 0, role: "region", "aria-label": "Mobile Navigation Content", children: /* @__PURE__ */ r("div", { className: "container mx-auto px-6", children: [
          ...
          /* @__PURE__ */ I("nav", { className: "flex flex-col gap-8 text-center mb-12", "aria-label": "Mobile site navigation", children: n.map((c, h) => {
            if (c.items && c.items.length > 0) {
              ...
              return /* @__PURE__ */ r("div", { className: "space-y-1", children: [
                ...
                /* @__PURE__ */ I("div", { className: "flex flex-col gap-1", children: y.map((G, M) => /* @__PURE__ */ I(
                  D,
                  {
                    to: G.url,
                    onClick: () => d(!1),
          ...
          C && /* @__PURE__ */ r(z, { children: [
            ...
            /* @__PURE__ */ I("div", { className: "max-w-md mx-auto space-y-6 pb-12", children: [
              ...
              /* @__PURE__ */ I("div", { className: "grid grid-cols-2 gap-2", children: c.items.map((y, G) => /* @__PURE__ */ I(
                "a",
                {
                  href: y.url,
    ...
    /* @__PURE__ */ I(
      "main",
      {
        id: "fc-main-content",
        className: "grow",
        style: { background: p.colors.bg.main, paddingTop: e ? j : 0 },
        ...m ? { inert: !0 } : {},
        children: o
      }
    ),
...
function UI({ theme: o, ...A }) {
  return /* @__PURE__ */ I(pI, { theme: o, children: /* @__PURE__ */ I(wI, { ...A }) });
}
const NI = ({ triggerText: o, tooltipContent: A, isActive: C, onToggle: e }) => {
  const { theme: g } = k(), [n, t] = F(!1), { refs: i, floatingStyles: b } = nI({
    placement: "bottom",
  ...
  return /* @__PURE__ */ r(z, { children: [
    ...
    u && /* @__PURE__ */ I(sI, { children: /* @__PURE__ */ I(
      "div",
      {
        ref: i.setFloating,
        style: b,
  ...
  const Q = (s, x) => {
    ...
    d.has(s) || v(new Set(d).add(s)), e(s);
  }, p = (s, x) => {
    g && g(s, x), E || t();
  };
  return /* @__PURE__ */ r(z, { children: [
    /* @__PURE__ */ I(B, { children: n && !E && /* @__PURE__ */ I(
      Z.div,
      {
        initial: { opacity: 0 },
        animate: { opacity: 1 },
          ...
          /* @__PURE__ */ r("nav", { className: "px-4 lg:pt-8", children: [
            ...
            /* @__PURE__ */ I("ul", { className: "space-y-4", children: o.map((s) => {
              ...
              return /* @__PURE__ */ r("li", { ref: (R) => {
                ...
                /* @__PURE__ */ I(B, { initial: !1, children: x && J && /* @__PURE__ */ I(
                  Z.ul,
                  {
...
function FI({ title: o, subtitle: A, image: C, video: e, isHomePage: g = !1 }) {
  const { theme: n } = k();
...
function QI({ title: o, children: A, className: C = "", style: e }) {
  const { theme: g } = k();
      ...
      /* @__PURE__ */ r("div", { className: "grid grid-cols-2 gap-3 mt-2", children: [
        /* @__PURE__ */ I(
          "a",
          {
            ...
            "aria-label": `Preview ${o} in a new tab`,
            children: "Preview"
          }
        ),
        /* @__PURE__ */ I(
...
function TI({ title: o, children: A, className: C = "" }) {
  const { theme: e } = k();
...
function YI({ preheader: o, title: A, url: C, className: e = "" }) {
  const { theme: g } = k();
  return /* @__PURE__ */ r(
    "a",
    {
...
function PI({ title: o, className: A = "" }) {
  const { theme: C } = k();
      ...
      /* @__PURE__ */ r("div", { className: "flex flex-col gap-2 mt-4", children: [
        e && /* @__PURE__ */ r(
          "a",
          {
            ...
            "aria-label": `Open address in Google Maps: ${e}`,
            children: [
              /* @__PURE__ */ I("span", { className: "mr-1.5", "aria-hidden": "true", children: "📍" }),
              /* @__PURE__ */ I("span", { className: "text-left leading-tight", children: e })
            ]
          }
        ),
...
export {
  ...
  dI as getActiveTheme,
  kI as getNativeMapUrl,
  gI as howDoIItems,
  X as residentsItems,
  k as useTheme,
  _ as visitorsItems
